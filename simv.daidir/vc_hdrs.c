...
#ifndef __VCS_IMPORT_DPI_STUB_aes_encrypt_dpi
#define __VCS_IMPORT_DPI_STUB_aes_encrypt_dpi
__attribute__((weak)) void aes_encrypt_dpi(/* INPUT */int A_1, /* OUTPUT */svBitVecVal *A_2, const /* INPUT */svBitVecVal *A_3, const /* INPUT */svBitVecVal *A_4)
{
    static int _vcs_dpi_stub_initialized_ = 0;
    static void (*_vcs_dpi_fp_)(/* INPUT */int A_1, /* OUTPUT */svBitVecVal *A_2, const /* INPUT */svBitVecVal *A_3, const /* INPUT */svBitVecVal *A_4) = NULL;
    if (!_vcs_dpi_stub_initialized_) {
        _vcs_dpi_fp_ = (void (*)(int A_1, svBitVecVal* A_2, const svBitVecVal* A_3, const svBitVecVal* A_4)) dlsym(RTLD_NEXT, "aes_encrypt_dpi");
    ...
    if (_vcs_dpi_fp_) {
        ...
        vcsMsgReport1("DPI-DIFNF", fileName, lineNumber, 0, 0, "aes_encrypt_dpi");
    }
}
#endif /* __VCS_IMPORT_DPI_STUB_aes_encrypt_dpi */
